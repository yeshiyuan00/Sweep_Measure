package com.ysy.sweepmeasure.helper;
...
public class SettingHelper {
    ...
    public static double getSharedPreferences(Context paramContext, String paramString, double paramInt) {
        return getSharedPreferencesObject(paramContext).getFloat(paramString, (float) paramInt);
    }
    ...
    public static void setEditor(Context paramContext, String paramString, double paramInt) {
        getEditorObject(paramContext).putFloat(paramString, (float) paramInt).commit();
    }
